        ...
        <div id="memo_nav_section" class="col-12 bg-white shadow nav-close">
            <div class="col-11 mx-auto my-3 overflow-hidden overflow-scroll">
                <div class="col-12 my-col">
                    <div class="memo-nav-items memo-yellow mx-3" data-type="post" data-color="yellow">
                        <div class="memo-header"></div>
                    </div>
                    <div class="memo-nav-items memo-pink mx-3" data-type="post" data-color="pink">
                        <div class="memo-header"></div>
                    </div>
                    <div class="memo-nav-items memo-green mx-3" data-type="post" data-color="green">
                        <div class="memo-header"></div>
                    </div>
                    <div class="memo-nav-items memo-blue mx-3" data-type="post" data-color="blue">
                        <div class="memo-header"></div>
                    </div>
                    <div class="memo-nav-items memo-img mx-3 text-center" data-type="image" data-color="img">
                        <div class="memo-header"></div>
                        <i class="bi bi-card-image text-success"></i>
                    </div>
                </div>
            </div>
        </div>
